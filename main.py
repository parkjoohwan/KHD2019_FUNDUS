...
from keras.layers import Conv2D, MaxPooling2D, Flatten, ZeroPadding2D, Input, Activation, Add, GlobalAveragePooling2D
...
from model import cnn_sample, custom_model, custom_model2
...
if __name__ == '__main__':
    ...
    # model = custom_model(in_shape=(h, w, 3), num_classes=num_classes)
    # model = custom_model2(in_shape=(h, w, 3), num_classes=num_classes)
